...
class Pengiriman_Model extends CI_Model
{
	...
	{
		$query = $this->db->query("SELECT id_barang from detail_pengiriman
	...
	public function get_detail_qty($id)
	{
		$query = $this->db->query("SELECT qty from detail_pengiriman
								   where id_pengiriman = '$id'
								   ");
	...
	public function get_harga($id)
	{
		...
		$query = $this->db->query("SELECT  harga_satuan
								   FROM barang 
								   WHERE id_barang = '$id'
								   ");
		$result = $query->result();
